...
local function refresh_chip()
	-- TODO: replace "YourCity" with your city name (e.g. "London", "New+York")
	sbar.exec([[curl -s 'https://wttr.in/YourCity?format=%t+%C' | tr -d '\n']], function(out)
...
local function refresh_popup()
	local url = "https://wttr.in/YourCity?format=j1"
